...
def integrate(ComplexFunction f, Contour contour, start=None, end=None, REAL tol=1e-3):
...
def derivative(ComplexFunction f, COMPLEX z0, size_t order=1, REAL radius=1e-3, REAL tol=1e-3):
...
def residue(ComplexFunction f, COMPLEX z0, REAL radius=1e-3, REAL tol=1e-3):
